<?php
  // Toto menu bude vygenerováno pro přihlášeného uživatele.
...
<header class="w3-top">
  <div class="w3-bar w3-top w3-left-align w3-xlarge <?php if (isset($_COOKIE['theme'])) {
    ...
    <a href="new_entry.php" class="w3-bar-item w3-button w3-hide-small w3-hover-white">Vytvořit příspěvek</a>
    <a href="index.php?logout=true" class="w3-bar-item w3-button w3-hide-small w3-hide-medium w3-hover-white">Odhlásit</a>
  </div>
</header>
...
<nav id="my-sidebar" class="w3-sidebar w3-bar-block w3-collapse w3-xlarge w3-animate-left <?php if (isset($_COOKIE['theme'])) {
  ...
  <h3 class="w3-bar-item w3-hide-large bold">Vítejte <?php echo $_SESSION['user']; ?></h3>
  <a href="about.php" class="w3-bar-item w3-button w3-hide-large w3-hover-black">O stránce</a>
  <a href="new_entry.php" class="w3-bar-item w3-button w3-hide-medium w3-hide-large w3-hover-black">Vytvořit příspěvek</a>

  <?php
    if ($_SESSION['user'] == 'admin') {     // Pokud je přihlášený uživatel "admin" má přístup ke stránce úpravy kategorií.
  ?>
  <h3 class="w3-bar-item w3-hide-small w3-hide-medium bold">Vítejte <?php echo $_SESSION['user']; ?></h3>
  <a href="edit_topics.php" class="w3-bar-item w3-button w3-hover-black">Upravit téma</a>
  <?php
    }
  ?>

  <a class="w3-bar-item w3-button w3-hover-black w3-hide-large" href="index.php?logout=true">Odhlásit</a>
